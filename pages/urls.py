...
urlpatterns = [
    ...
    path('image/', ImageViewFactory(settings.IMAGE_STORAGE).as_view(), name='image_index'),
    path('image/save/', ImageViewFactory(settings.IMAGE_STORAGE).as_view(), name='image_save'),
