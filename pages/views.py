...
class ProductTableView(View):
    template_name = 'products/table.html'

    def get(self, request):
        viewData = {}
        viewData["title"] = "Products Table - Online Store"
        viewData["subtitle"] = "Lista de Productos en Tabla"
        viewData["products"] = Product.objects.all().order_by('-created_at')
        return render(request, self.template_name, viewData)
